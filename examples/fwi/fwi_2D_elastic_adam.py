...
RESOLUTION = (256, 256)
SPACE_ORDER = 2
SPACE_ORDER_OBS = 4  # the measurement is simulated more accurately than it is inverted
SAFETY = 0.9
...
N = math.ceil(T / (SAFETY * stable_dt(dx, WAVESPEED_P, 2))) + 1
N_obs = math.ceil(T / (SAFETY_OBS * stable_dt(dx, WAVESPEED_P, 2))) + 1
...
sim_obs = elastic_wave(N_obs, dt_obs, SPACE_ORDER_OBS)
