...
- [sensitivity](sensitivity.md) with [scalar backward CUDA](cuda_scalar_sensitivity.md), [elastic backward CUDA](cuda_elastic_sensitivity.md) and [anisotropic backward CUDA](cuda_anisotropic_sensitivity.md) kernels
## optimization
